...
function FormStockMovement() {
    ...
    const productQuantitySelector = ({ products = []}) => {
        const selectedProductQuantity = products.find(p => p.id === selectedProductQuantity)
    }
                        ...
                        <div className="productStockContainer">
                            ...
                            <div className="stockSection">
                                ...
                                <ul>
                                    <li>
                                        {selectedProduct
                                            ? selectedProduct.stock?.actual_quantity || 0
                                            : ''}
                                    </li>
                                </ul>
                            </div>
